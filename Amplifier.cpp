 ...
 */
uint8_t AmplifierClass::set(uint16_t VoltageInMvRms)
{
  uint8_t ErrorCounter = 0;
  
  q23_8_t ResistanceInOhmsQ23_8;
  
  uint16_t R0ResistanceInTaps;
  uint16_t R1ResistanceInTaps;
  ...
  if (VoltageInMvRms <= 350)
  {
    ...
    R1ResistanceInTaps = ResistanceInOhmsQ23_8 / 10000;  // 10,000 / 256 = 39.0625 ohms per tap, converted to Q8 format it is 10,000 ohms/tap
